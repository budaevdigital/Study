...
def to_buy_bycycle_binary_search(arr_numbers: List[int], cost_bike: int, days_left: int, days_right: int) -> List[str]:
    ...
    if arr_numbers[days_middle] == cost_bike:
        ...
        return to_buy_bycycle_binary_search(arr_numbers, cost_bike, days_left, days_middle)
    else:
        return to_buy_bycycle_binary_search(arr_numbers, cost_bike, days_middle + 1, days_right)
...
def find_first_day_to_buy(days: int, arr_numbers: int, cost_bike: int) -> int:
    ...
    return to_buy_bycycle_binary_search(arr_numbers=arr_numbers, cost_bike=cost_bike, days_left=0, days_right=days) + 1
